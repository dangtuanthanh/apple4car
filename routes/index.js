...
//todo API hiển thị bài viết lên trang chủ

router.get("/posts", function (req, res, next) {
  sql.hienthibaiviet().then((result) => {
    res.json(result);
  });
});

router.get("/layuserid/:id", function (req, res, next) {
  const IDUsers = req.params.id; // Lấy id contact từ tham số đường dẫn
